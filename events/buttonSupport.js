// Users can click the button to open a ticket to request technical assistance, the corresponding permissions will be granted to the user and a messege will be sent in that new ticket

// Users can click the button to open a ticket to apply to work on the staff team, the corresponding permissions will be granted to the user and a messege will be sent in that new ticket
